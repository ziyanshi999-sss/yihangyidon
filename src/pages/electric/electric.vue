<template>
  <view class="electric-page">
    ...
    <!-- 电力公司选择 -->
    <view class="company-section" v-if="electricCompanies.length > 0">
      <view class="section-header">
        <text class="section-title">选择电力公司</text>
        <text class="company-count">{{ electricCompanies.length }}家公司</text>
      </view>

      <view class="company-list">
        <view
          class="company-item"
          v-for="(company, index) in electricCompanies"
          :key="index"
    ...
    <!-- 暂无服务提示 -->
    <view class="no-service" v-if="electricCompanies.length === 0">
      <view class="no-service-icon">⚡</view>
      <text class="no-service-title">暂无电费服务</text>
      <text class="no-service-desc"
        >{{ selectedCity }}暂未开通电费缴费服务</text
      >
      <text class="no-service-tip">请联系当地供电公司或稍后再试</text>
    </view>

    <!-- 底部说明 -->
    <view class="footer-info">
      <text class="info-text">• 缴费成功后，请保留缴费凭证</text>
      <text class="info-text">• 如有疑问，请联系供电公司客服</text>
